namespace TicTacToe.Web.Controllers
{
    ...
    public class GamesController : BaseApiController
    {
        ...
        //    : this(new TicTacToeData(TicTacToeDbContext.Create()), new GameResultValidator(), new AspNetUserIdProvider())
        //{
        //}
        ...
        public IHttpActionResult Play(PlayRequestDataModel request)
        {
            ...
            request.GameId = this.data.Games
                                 .All()
                                 .FirstOrDefault(g => (g.FirstPlayer.Id == currentUserId || g.SecondPlayer.Id == currentUserId) &&
                                                      (g.State != GameState.WonByO || g.State != GameState.WonByX || g.State != GameState.Draw))
                                 .Id.ToString();
